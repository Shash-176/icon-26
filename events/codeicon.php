...
$eventt = "codeicon"; //change this according to your event from shared sheet
$amount = 400; //change this according to your event from shared sheet
?>
<script>
        // alert('The registrations of CODEICON will start soon, please check again later.');
        // window.location.href="https://www.icon-somaiya.in/index.html#events";
</script> 
        ...
        <div class="row wow fadeInUp">
            ...
            <div class="col-md-10" style="border:1px solid black;padding:10px;">
                ...
                <div class="form-group row">
                            ...
                            <div class=" form-group col-md-12">
                                <label for="teamname">Enter Team Leader Name <span
                                        style="color:#b7202e;">*</span></label>
                                <br>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="player2_name" id=""
                                    placeholder="Player2 Name" required />
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="tel" class="form-control" name="player2_mob" minlength="10" maxlength="10"
                                    onkeypress="return onlyNumberKey(event)" id="" placeholder="Your Phone No."
                                    required />
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-12">
                                <h3 class="text-center">Player<?php echo $x + 1; ?>(Optional)</h3>
                                ...
                                <input type="text" class="form-control" name="player<?php echo $x + 1; ?>_name" id=""
                                    placeholder="Player<?php echo $x + 1; ?> Name" />
                            ...
                            <div class="form-group col-md-12">
                                <label for="teamname">Enter Email <span style="color:#b7202e;"></span></label>
                                <br>
                                <input type="email" class="form-control" name="player<?php echo $x + 1; ?>_email" id=""
                            ...
                            <div class="form-group col-md-12">
                                <label for="teamname">Enter Contact No <span style="color:#b7202e;"></span></label>
                                <br>
                                <input type="tel" class="form-control" name="player<?php echo $x + 1; ?>_mob"
                                    minlength="10" maxlength="10" onkeypress="return onlyNumberKey(event)" id=""
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="player<?php echo $x + 1; ?>_clgname" id=""
                                    placeholder="Player<?php echo $x + 1; ?> College Name" />
                            </div>
