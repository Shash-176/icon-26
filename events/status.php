...
if (
    ...
    $_SESSION['game'] == 'shutter_symphony' ||
    $_SESSION['game'] == 'drag and drop' ||
    $_SESSION['game'] == 'coding_decoding' ||
    $_SESSION['game'] == 'table_tennis' ||
    $_SESSION['game'] == 'ad_mad_show' ||
    $_SESSION['game'] == 'virtual_trading' 
    ...
    $ins_query = "INSERT into solo
      ...
      VALUES('$playername','$mobno','$mobno2','$primemail','$clgname','$idcard','$eventname')";
    ...
    if (isset($_FILES["transaction_image"]) && $_FILES["transaction_image"]["error"] == 0) {
        ...
        if (in_array($filetype, $allowed)) {
            ...
            if (file_exists("payment/" . $filename)) {
                ...
                // ! each payment_ack for sep folder for each event
...
//roadside_revelry  
elseif ($_SESSION['game'] == 'roadside_revelry') {
    $teamname = $_SESSION['teamname'];
    $playername = $_SESSION['playername'];
    $clgname = $_SESSION['clgname'];
    $email = $_SESSION['email'];
    ...
    */
    $insert2 = "INSERT into team_member_details
    (teamname ,game ,Member_Name ,clg_name)
    VALUES
...
elseif ($_SESSION['game'] == 'codeicon') {
    ...
    */
    $insert2 = "INSERT into codeicon_gallery_team_member_details
    (teamname ,game ,Member_Name ,email,contact,clg_name)
    VALUES
    ...
    //
    $insert3 = "INSERT into codeicon_gallery_team_member_details
    (teamname ,game ,Member_Name ,email,contact,clg_name)
    VALUES
    ...
    //echo"<br/>3". $insert3;
    //
    $insert4 = "INSERT into codeicon_gallery_team_member_details
    (teamname ,game ,Member_Name ,email,contact,clg_name)
    VALUES
...
*/ elseif ($_SESSION['game'] == 'gallery') {
    ...
    $insert = "INSERT into team_details(
    teamname,teamleader_name,contact,
    secondarycontact,email,clg_name,clgproof,game,gallery_summary)
    VALUES
    ('$teamname','$playername','$mob1','$mob2',
...
elseif ($_SESSION['game'] == 'football') {
 ...
 elseif (
    $_SESSION['game'] == 'treasure_hunt' ||
    $_SESSION['game'] == 'tech_knowledge' ||
    $_SESSION['game'] == 'spark_tank' ||
    $_SESSION['game'] == 'break_the_query'
) {
    $teamname = $_SESSION['teamname'];
    $playername = $_SESSION['playername'];
    $clgname = $_SESSION['clgname'];
    ...
    if (mysqli_query($conn, $query)) {
        ...
        elseif ($eventname == 'bgmi') {
         ...
         elseif (
            ...
            $eventname == 'break_the_query' ||
            $eventname == 'spark_tank'
        ) {
            echo "idg";
            team_events($insert, $conn);
            team_events($insert2, $conn);
        ...
        elseif ($eventname == 'gallery' || $eventname == 'roadside_revelry') {
            ...
            <div class="col-md-6 mx-auto mt-5">
                <div class="payment">
                    ...
                    <div class="content">
                        ...
                        <a href="https://icon-somaiya.in/index.html">Done</a>
                        <p class="note">Please note we will soon share final acknowledgment over e-mail once transaction
                            is validated</p>
                    </div>
