...
$eventt = "table_tennis"; //change this according to your event from shared sheet
                ...
                <form action="orderSummary.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <div class=" form-group col-md-12">
                            ...
                            <br>
                            <input type="text" class="form-control" name="player_name" id="" placeholder="Player Name" required />
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <br>
                            <input type="email" class="form-control" name="primary_email" id="" placeholder="Enter Email Id Of Player" required />
                        </div>
