...
$eventt = "tech_knowledge"; //change this according to your event from shared sheet
                ...
                <div class="form-group row">
                                        <div class=" form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="teamname" id=""
                                                placeholder="provide unique Team Name" required />
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="teamname">Participant Mobile number <span
                                                    style="color:#b7202e;">*</span></label>
                                            <br>
                                            <input type="text" class="form-control" name="primary_mob1" minlength="10"
                                                maxlength="10" onkeypress="return onlyNumberKey(event)" id=""
                                                placeholder="Your Phone No." required />
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label for="teamname">Alternate Mobile number <span
                                                    style="color:#b7202e;">*</span></label>
                                            <br>
                                            <input type="text" class="form-control" name="primary_mob2" minlength="10"
                                                maxlength="10" onkeypress="return onlyNumberKey(event)" id=""
                                                placeholder="Your Alternate Phone No." required />
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <br><input type="text" name="player2_name" class="form-control" id=""
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="file" placeholder="Please upload file in pdf format"
                                                class="form-control" name="player_image" id="" placeholder=""
                                                required />
                                        </div>
