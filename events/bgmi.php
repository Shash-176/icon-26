...
$eventt = "bgmi"; //change this according to your event from shared sheet
$amount = 300; //change this according to your event from shared sheet
?>
        ...
        <div class="row wow fadeInUp">
            ...
            <div class="col-md-10" style="border:1px solid black;padding:10px;">
                ...
                <div class="form-group row">
                        ...
                        <div class="form-group col-md-12">
                            <label for="teamname">Enter Team Leader BGMI ID <span
                                    style="color:#b7202e;">*</span></label>
                            <br>
                            <input type="text" class="form-control" name="teamcap_igname" id=""
                                placeholder="BGMI ID" required />
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="form-group col-md-12">
                            ...
                            <label for="teamname">Enter Player<?php echo $x + 1; ?> BGMI ID <span
                                    style="color:#b7202e;">*</span></label>
                            <br>
                            <input type="text" class="form-control" name="player<?php echo $x + 1; ?>_igname" id=""
                                placeholder="Player<?php echo $x + 1; ?> BGMI ID" required />
                        </div>
