...
if (
    ...
    $_POST['event_name'] == 'shutter_symphony' ||
    $_POST['event_name'] == 'drag and drop' ||
    $_POST['event_name'] == 'table_tennis' ||
    $_POST['event_name'] == 'coding_decoding' ||
    $_POST['event_name'] == 'virtual_trading' 
) {
...
elseif ($_POST['event_name'] == 'roadside_revelry') {
    $teamname = $_POST['teamname'];
    $_SESSION['teamname'] = $_POST['teamname'];
...
===================*/ elseif ($_POST['event_name'] == 'gallery') {
    ...
    $_SESSION['executive_summary'] = $_POST['executive_summary'];
...
elseif ($_POST['event_name'] == 'football') {
    $teamname = $_POST['teamname'];
    $_SESSION['teamname'] = $_POST['teamname'];
 ...
 elseif (
     ...
     $_POST['event_name'] == 'spark_tank' ||
     $_POST['event_name'] == 'break_the_query'
     ) {
    $teamname = $_POST['teamname'];
    $_SESSION['teamname'] = $_POST['teamname'];
              ...
              <input type="text" name="game" id="" class="form-control" value="<?php echo $teamname; ?>" readonly="True" />
                ...
                <input type="text" class="form-control" name="payee_amount" value="<?php echo $actual_amount; ?>" id="finalamount" readonly="True" />
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <br><br>
                                <h4 class="text-center">Or Pay to: 8879563874</h4>
                            </div>
                            <br><br>
                            <div class=" form-group col-md-12">
                                <p class="idnote">Important note:
                                    <br>1. Scan the QR CODE and pay the above mentioned amount.
                                    <br>2. While uploading Screenshot, please rename the screenshot file name as
                                    yourname and upload Screenshot Showcasing Transaction Detail.
                                    <br>3. While making the payment, please add a note in the payment description in the
                                    following format:ICON-EventName-YourName
                            ...
                            if (
                                ...
                                $_POST['event_name'] == 'roadside_revelry' ||
                                $_POST['event_name'] == 'spark_tank' ||
                                $_POST['event_name'] == 'break_the_query' ||
                                $_POST['event_name'] == 'bgmi'
                            ) {
                            ...
                            <script type="text/javascript">
                                function chkfile() {
                                    ...
                                    if (ext.includes(extension) == true) {
                                        ...
                                        document.getElementById('hint').innerHTML =
                                            "4. Please upload only .png ,.jpg or .jpeg format";
