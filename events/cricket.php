...
$eventt = "cricket"; //change this according to your event from shared sheet
$amount = 1000; //change this according to your event from shared sheet
?>
                    ...
                    <!--valorant-->
                                ...
                                <div class="form-group row">
                                    <div class=" form-group col-md-12">
                                        <label for="teamname">Enter TeamName cricket                                            <span style="color:#b7202e;">*</span></label>
                                        <br>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <br>
                                        <input type="text" class="form-control"
                                            name="player6_clgname" id=""
                                            placeholder="Player6 college name" required />
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <br>
                                        <input type="text" class="form-control"
                                            name="player7_clgname" id=""
                                            placeholder="Player7 college name" required />
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <br>
                                        <input type="text" class="form-control"
                                            name="player8_clgname" id=""
                                            placeholder="Player8 college name" required />
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-md-12">
                                        <h3 class="text-center">Player9</h3>
                                        <label for="teamname">Enter Player9 Name <span
                                                style="color:#b7202e;">*</span></label>
                                        <br>
                                        <input type="text" class="form-control" name="player9_name"
                                            id="" placeholder="Player9 name" required />
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <br>
                                        <input type="text" class="form-control"
                                            name="player9_clgname" id=""
                                            placeholder="Player9 college name" required />
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-md-12">
                                        <h3 class="text-center">Player10</h3>
                                        <label for="teamname">Enter Player10 Name <span
                                                style="color:#b7202e;">*</span></label>
                                        <br>
                                        <input type="text" class="form-control" name="player10_name"
                                            id="" placeholder="Player10 name" required />
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <br>
                                        <input type="text" class="form-control"
                                            name="player10_clgname" id=""
                                            placeholder="Player10 college name" required />
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-md-12">
                                        <h3 class="text-center">Player11</h3>
                                        <label for="teamname">Enter Player11 Name <span
                                                style="color:#b7202e;">*</span></label>
                                        <br>
                                        <input type="text" class="form-control" name="player11_name"
                                            id="" placeholder="Player11 name" required />
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <br>
                                        <input type="text" class="form-control"
                                            name="player11_clgname" id=""
                                            placeholder="Player11 college name" required />
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-md-12">
                                        <h3 class="text-center">Player12 (Optional)</h3>
                                        <label for="teamname">Enter Player12 Name <span
                                                style="color:#b7202e;"></span></label>
                                        <br>
                                        <input type="text" class="form-control" name="player12_name"
                                            id="" placeholder="Player12 name" />
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="teamname">Enter College Name <span
                                                style="color:#b7202e;"></span></label>
                                        <br>
                                        <input type="text" class="form-control" name="player12_clgname"
                                            id="" placeholder="Player12 college name" />
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-md-12">
                                        <h3 class="text-center">Player13 (Optional)</h3>
                                        <label for="teamname">Enter Player13 Name <span
                                                style="color:#b7202e;"></span></label>
                                        <br>
                                        <input type="text" class="form-control" name="player13_name"
                                            id="" placeholder="Player13 name" />
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="teamname">Enter College Name <span
                                                style="color:#b7202e;"></span></label>
                                        <br>
                                        <input type="text" class="form-control" name="player13_clgname"
                                            id="" placeholder="Player13 college name" />
                                    </div>
